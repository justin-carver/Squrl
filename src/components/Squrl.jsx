...
const Squrl = () => {
    ...
    return(
        <div className="Squrl flex flex-col mb-16 rounded-lg dark:bg-gray-700 p-10">
            <p className="text-black dark:text-white font text-4xl lowercase font-logo tracking-wide">Encrypter <FontAwesomeIcon icon={faKey} /></p>
            <p className="Squrl__about py-4 text-gray-300">
                Squrl, <a href="https://github.com/justin-carver/squrl" className="text-gray-400 underline underline-offset-4">
                    ...
                    Click <a href="https://github.com/justin-carver/squrl#end-to-end-encryption-" className="text-gray-400 underline underline-offset-4">here</a> to see more information about what kind of encryption Squrl offers.<br/><br />
